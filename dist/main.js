    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (deviceId) {
                ...
                micDevice = deviceEntries.find(d => d?.name.includes('Microphone') ||
                    d?.name.includes('mic') ||
            ...
            const stopMethods = [
                ...
                async () => {
                    try {
                        ...
                        const pkillProcess = (0, child_process_1.spawn)('pkill', ['-f', 'ffmpeg']);
                        return new Promise(resolve => {
    ...
    if (devices.length === 0) {
        ...
        try {
            ...
            const scriptResult = await new Promise((resolve, reject) => {
                const script = (0, child_process_1.spawn)('osascript', [
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (existingMultiOutput) {
                ...
                const setDefaultCmd = (0, child_process_1.spawn)('osascript', [
      ...
      tell application "Audio MIDI Setup"
        ...
        on error errMsg
          return "Error: " & errMsg
            ...
            const createMultiOutputCmd = (0, child_process_1.spawn)('osascript', ['-e', script]);
            let stdout = '';
            let stderr = '';
            ...
            createMultiOutputCmd.on('close', (code) => {
              ...
              tell window 1
                repeat with uiRow in (get rows of table 1 of scroll area 1)
                  if name of static text 1 of uiRow contains "BlackHole" or name of static text 1 of uiRow contains "${targetOutputName}" then
                    ...
                    const openMidiSetup = (0, child_process_1.spawn)('osascript', ['-e', script2]);
