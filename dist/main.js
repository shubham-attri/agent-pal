    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (microphoneIndex) {
                ...
                audioProcess = (0, child_process_1.spawn)('ffmpeg', micArgs, {
    ...
    return new Promise(async (resolve) => {
        ...
        if (currentRecordingSession && currentRecordingSession.path) {
            ...
            try {
                if (fs.existsSync(recordingsDir)) {
                    ...
                    const directories = files.filter(file => fs.statSync(path.join(recordingsDir, file)).isDirectory());
        ...
        try {
            ...
            if (!processKilled) {
                ...
                const pkillProcess = (0, child_process_1.spawn)('pkill', ['-INT', '-f', 'ffmpeg']);
                // Wait for pkill to complete
                await new Promise((pkillResolve) => {
            ...
            if (!processKilled) {
                ...
                (0, child_process_1.spawn)('pkill', ['-9', '-f', 'ffmpeg']);
            }
